...
// Response Messages
const MESSAGES = {
  unauthorizedError: "You are not authorized to unban users",
  successMessage: (username) => `${username} is now unbanned`,
};
 ...
 * @param {Object} targetUser - The user to be unbanned.
 */
const unbanUser = async (ws, channelId, user, targetUser) => {
